...
let getData = () => fetch("https://food-deliveryapp.herokuapp.com/api/hotels").then(data => data.json());
...
let getHotelCard = singleHotelData => {
    ...
    return `<div class="col-md-3">
      <div class="card">
        <img class="card-img-top" src="https://images.all-free-download.com/images/graphiclarge/fries_and_steak_on_plate_193268.jpg" alt="Card image">
        <div class="card-body">
          ...
          <div>
            <div class="rating">
             ...
             <span class="eta"> ${singleHotelData.eta} MINS </span>
              <a href="newmenu.html" class="view-menu" >View Menu</a>
              </div>
        </div>
      </div>
</div>`;
